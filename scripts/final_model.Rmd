...
# using NYT classification of states... MOVING TEXAS AND SC HAS RESULT ON OUTCOME OF THE MODEL?
...
bg_states <- c("FL", "IA", "OH", "GA", "NC", "ME", "NC", "MI", "MN", "NE", "NH", "PA", "WI", 
               "NV", "AZ", "NM", "MT")
rep_states <- c("AK", "IN", "KS", "MO", "AL", "AR", "ID", "KY", "LA", "MS", "ND", "OK", "SD", "TN", "WV", "WY", "TX", "SC", "UT")
