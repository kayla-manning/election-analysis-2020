...
ggsave("../figures/swing_map.jpg", height = 5)
...
pv_swing_2016 %>% 
  ...
  gtsave("../figures/swing_table.html")
...
pv_swing_2016 %>% 
  ...
  theme_classic() + 
  labs(title = "Electoral Swing in Battleground States from 2012 to 2016",
       y = "Change in Democratic Percentage of Two-Party Vote",
       x = "State") +
