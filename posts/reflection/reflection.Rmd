...
state_pop_votes %>% 
  ...
  labs(title = "Partisan Shifts Since 2000",
       ...
       x = "",
       caption = "The dotted line indicates the predicted democratic margin. Notice that all of \nthe lines lie behind the trends set in the previous two elections.") +
