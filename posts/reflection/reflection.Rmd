...
The actual Electoral College outcome, with each candidate winning the states that they ultimately won in the election, occurred in `r times`, or `r round(times / 100000, 3)`, of my simulations. For additional context, my exact point prediction occurred in `r pred_times` of my simulations, which only equates to `r round(pred_times / 100000, 3)`% of my simulations. Using a frequentist[^frequentist] approach to probability, my forecast could have generate the exact probabilities and we just happened to observe one of the `r times` elections where each candidate won this exact cocktail of states.
